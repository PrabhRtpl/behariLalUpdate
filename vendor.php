                ...
                <div class="col-lg-12">
                    <div class="breadcrumb__content">
                        ...
                        <nav class="breadcrumb">
                            ...
                            <span property="itemListElement" typeof="ListItem">Registration</span>
                        </nav>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-8 m-auto">
                        <div class="consultation__form-wrap">
                            ...
                            <form action="#" class="consultation__form">
                                ...
                                <div class="form-grp col-12 col-md-6 col-lg-4">
                                    <label for="number">Website URL</label>
                                    <input type="name" id="website">
                                </div>
                                <div class="form-grp col-12 col-md-6 col-lg-4">
                                    <label for="number">Designation</label>
                                    <input type="name" id="designation">
                                </div>
                                <div class="form-grp col-12 col-md-6 col-lg-4">
                                    <label for="number">State</label>
                                    <input type="name" id="state">
                                </div>
                                <div class="form-grp col-12 col-md-6 col-lg-4">
                                ...
                                <div class="form-grp col-12 col-md-6 col-lg-12">
