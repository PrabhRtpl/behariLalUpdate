                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content-two">
                            ...
                            <p>Behari Lal Ispat Private Limited is a Special Steels Manufacturing Company committed to satisfy its customers by providing quality products consistently in accordance with customer specific requirements. The plant comprises of Modern Technology Fully Integrated Digital Steel Melting Shop with Vacuum Degassing(VD), Foundry, Heat Treatment and Machine Shop.</p>
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content-three">
                            ...
                            <p>Behari Lal Ispat has evolved through the years, from a small beginning to being one of the leading Integrated Steel Foundries in India with automated, state of the art production technology and a highly skilled work force to maintain competitiveness and to meet customer's genuine demands. Products are consistently superior, modern, reliable and delivered on time.</p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="cta__content-two">
                            <h2 class="title">World Class Steel Products in Quality, Productivity and Customer Satisfaction.</h2>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="cta__btn">
                            <a href="javascript::void()" class="btn btn-two">Explore Our Products <img src="assets/img/icons/right_arrow.svg" alt="" class="injectable"></a>
                            <a href="javascript::void()" class="btn transparent-btn popup-video">Watch Our Story <i class="renova-play"></i></a>
                        </div>
                    </div>
                </div>
            </div>
